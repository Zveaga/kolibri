        ...
        return [
          {
            ...
            minWidth: '300px',
            width: '40%',
            columnId: this.coreString('fullNameLabel'),
          },
          {
            ...
            minWidth: '150px',
            width: '20%',
            columnId: this.coreString('usernameLabel'),
          },
          {
            ...
            minWidth: '150px',
            width: '10%',
            columnId: this.coreString('identifierLabel'),
          },
          {
            ...
            minWidth: '150px',
            width: '10%',
            columnId: this.coreString('genderLabel'),
          },
          {
            ...
            minWidth: '100px',
            width: '10%',
            columnId: this.coreString('birthYearLabel'),
          },
          {
